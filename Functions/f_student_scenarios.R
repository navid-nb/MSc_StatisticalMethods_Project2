f_student_scenarios <- function(mu_returns, sigma_returns, degrees_freedom, n_scenarios, T, spot_price) {
  # Generate iid student distributed scenarios for the underlying asset price
  # mu_returns: Mean of the daily log-returns
  # sigma_returns: Standard deviation of the daily log-returns
  # degrees_freedom: Degrees of freedom for the student distribution
  ...
  log_return_scenarios <- matrix(rt(T * n_scenarios, mean =mu_returns, sd = sigma_returns), nrow = n_scenarios, ncol = T)
